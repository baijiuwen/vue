<template>
  <p>dialogComponent.vue</p>
  <div>
    <div style="width: 100%;height: 100px;">
      <!-- 添加会员 -->
      <el-button type="primary" @click="sendmessage"
        style="margin-top: 30px;float: left; margin-left: 10px;margin-bottom: 25px;"><i
          class="el-icon-s-promotion">发送</i></el-button>
      <el-button type="primary"
        style="margin-top: 30px;float: left; margin-left: 5px;margin-bottom: 25px;">√全选</el-button>
      <el-button type="primary"
        style="margin-top: 30px;float: left; margin-left: 5px;margin-bottom: 25px;">×批量删除</el-button>
